  ...
  return (
    ...
    >
      <div
        ...
        className="no-scrollbar absolute bottom-0 left-0 h-[300px] w-[100%] items-center justify-center overflow-x-hidden overflow-y-scroll rounded-t-[1.5rem] bg-white p-[1rem] opacity-100"
      >
        <div className="mb-[1.5rem] mr-4">
          <DashboardHeader />
        </div>
        <nav className="flex flex-col gap-2">
          <button
            ...
            className={
              active_section === "dashboard" ? activeLink : inactiveLink
            }
          >
            <svg
          ...
          <button
            ...
            className={
              active_section === "products" ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <svg
              ...
              stroke="currentColor"
              className={
                active_section === "orders" ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
          ...
          <button
            onClick={() => updateQueryParams("section", "admins")}
            className={active_section === "admins" ? activeLink : inactiveLink}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              ...
              stroke="currentColor"
              className={
                active_section === "admins" ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
          ...
          <button
            onClick={() => updateQueryParams("section", "settings")}
            className={
              active_section === "settings" ? activeLink : inactiveLink
            }
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              ...
              stroke="currentColor"
              className={
                active_section === "settings" ? activeIcon : inactiveIcon
              }
            >
              <path
                strokeLinecap="round"
