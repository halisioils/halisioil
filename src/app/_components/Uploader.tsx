      ...
      <div className="space-y-2">
        ...
        {files.length > 0 && (
          <button
            ...
            className="mt-[1rem] flex h-10 w-full items-center justify-center rounded-md border border-gray-200 bg-gray-100 text-sm text-gray-700 transition-all duration-300 ease-in-out hover:bg-white hover:text-black focus:outline-none disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-100 disabled:text-gray-400"
          >
            Reset
          </button>
        )}
