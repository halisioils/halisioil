...
/**
 * Private normal user (authenticated) procedure
 *
 * This is the base piece you use to build new queries and mutations on your tRPC API. It does
 * guarantee that a user querying is authenticated, you can access user session data if they
 * are logged in.
 */
...
/**
 * Private admin user (authenticated) procedure
 *
 * This is the base piece you use to build new queries and mutations on your tRPC API. It does
